	...
	<div class="container">
		<div class="profile">
			<button class="profile__avatar" id="toggleProfile">
				<img
					src="https://pbs.twimg.com/profile_images/554631714970955776/uzPxPPtr.jpeg"
					alt="Avatar" />
			</button>
			<form action="connexion.aspx" method="post">
				<div class="profile__form">
					<div class="profile__fields">
						<div class="field">
							<input type="text" name="nom_utilisateur" id="fieldUser"
								class="input" required pattern=.*\S.* /> <label for="fieldUser"
								class="label">Username</label>
						</div>
						<div class="field">
							<input type="password" name="password" id="fieldPassword"
								class="input" required pattern=.*\S.* /> <label
								for="fieldPassword" class="label">Password</label>
						</div>
						<div class="profile__footer">
							<button type="submit" class="btn">Login</button>
						</div>
						<a id="creercompte" href="creercompte.aspx">creer nouveau
							compte</a>
					</div>
...
document.getElementById("creercompte").addEventListener('mouseover',function(){
	document.getElementById("creercompte").style.color="red";
});

document.getElementById("creercompte").addEventListener('mouseout',function(){
	document.getElementById("creercompte").style.color="#000000";
});
